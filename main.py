...
def checkings(df,df2,p,d,q,p2,d2,q2):
    """
    Perform ARIMA modeling and prediction on the given dataframes.

    Args:
        df (Dataframe): Training data.
        df2 (Dataframe): Test data.
        p (int): Autoregressive order of ARIMA.
        d (int): Differencing order of ARIMA.
        q (int): Moving average order of ARIMA.
        p2 (int): Autoregressive order of seasonal ARIMA.
        d2 (int): Differencing order of seasonal ARIMA.
        q2 (int): Moving average order of seasonal ARIMA.

    Returns:
        tsa.arima.model.ARIMAResultsWrapper: Results and statistics of the model.
        int: Mean Squared Error (MSE) of the prediction.

    Examples:
        Example usage of the function:
        >>> checkings(df_bo2_train, df_bo2_test, 1, 0, 1, 1, 1, 0)
        (ARIMAResultsWrapper, 501.923)
...
#Ahora se realiza la predicción con todos los datos
